		...
		<div id="mainContent">
			...
			<center>
				...
				<table width="318" border="1">
					...
					<tr><th width="19" height="15" scope="row">考生姓名</th>
						<td width="180"><jsp:getProperty property="examName" name="examineeinfo" /></td>
						<td width="40">性别</td>
						<td><jsp:getProperty property="sex" name="examineeinfo" /></td>
					</tr>
					<tr>
						<th scope="row">学校</th>
